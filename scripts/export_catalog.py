...
METAL_MAP = {
    ...
    "Золото 585 желтое":       ("Золото 585",  "Золото 585 жёлтое"),  # без ё — нормализуем
...
def normalize_type(product_type, subtype=None):
    ...
    # "Икона" отсутствует как тип в aquamarine.db — объединяем с Подвесками,
    # чтобы товары из обеих БД попадали в одну категорию.
    # if s == "Икона":  return "Икона"
    # Брошь и Булавка — единая категория в обеих БД
    if t in ("Брошь", "Булавка"): return "Броши и Булавки"
    return t
